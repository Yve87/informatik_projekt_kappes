...
# This keyboard interupt error is required for BatchJob multiprocessing interuptions. For some reason python does not handle regular KeyboardInterrupt as expected.
